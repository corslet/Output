...
<div data-options="region:'north',href:'${pageContext.request.contextPath}/layout/north.jsp'" style="height:100px; background(url:'resources/sypro.png');" class="logo"></div>
<div data-options="region:'south'" style="height:20px;"></div>
<div data-options="region:'east',iconCls:'icon-reload',split:true" style="width:100px;"></div>
<div data-options="region:'west',title:'导航菜单',split:true,href:'${pageContext.request.contextPath}/layout/west.jsp'" style="width:200px;"></div>
<div data-options="region:'center',title:'欢迎使用后台管理系统'"  style="fit">
    <div id="index_tabs" style="overflow: hidden;">
        <div title="公告" data-options="border:false" >
